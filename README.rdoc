...
Gentoo has CouchDB 0.8.1 in portage now. However this scanty won't work with 0.8.1 so you need to install edge.
...
Works with CouchDB 0.9.0a (r759914) & couchrest 0.22
